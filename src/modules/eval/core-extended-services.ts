...
export const CORE_EXTENDED_SERVICES = [MetricRegressionService, DataValidationService, ResultShardingService, PerformanceAnalysisService, TaskDependencyService, ResultIndexService, DataDeduplicationService, InferenceOptimizationService, ResultArchivalService, TaskRetryService, ValidationRuleService, ResultMergeService, TaskBatchService, DataMigrationService, CanaryReleaseService, ResultVisualizationService, TaskSchedulerService, DataSyncService, EvalBenchmarkService, ResultComparisonService, DataBackupService, AdvancedOrchestrationService, AdvancedTransformService, ModelRoutingService, AdvancedAggregationService, TaskMonitoringService, AdvancedCleaningService, AdvancedModelEvalService, AdvancedExportService, AdvancedQueueService, AdvancedAnnotationService, AdvancedReportService, AdvancedComparisonService, AdvancedSubscriptionService, AdvancedPriorityService, AdvancedShardingService, AdvancedCacheService, AdvancedRetryService, AdvancedRegistryService, AdvancedIndexService, AdvancedValidationService, AdvancedTemplateService, AdvancedPipelineService, AdvancedDependencyService, AdvancedArchiveService];
