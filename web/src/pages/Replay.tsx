  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium flex items-center gap-2"><Repeat className="h-5 w-5" /> 评测回放</h3>
        <Button size="sm" onClick={() => setCreateOpen(true)}><Plus className="mr-2 h-3.5 w-3.5" />新建回放</Button>
      </div>
      <Table>
            <TableHeader>
              <TableRow>
